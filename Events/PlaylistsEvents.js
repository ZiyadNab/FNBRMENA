            ...
            if(status === true){
                ...
                .then(async res => {
                    ...
                    if(JSON.stringify(enabled) !== JSON.stringify(response)){
                        ...
                        //date
                        moment.locale(lang)
                        if(lang === "en") var date = moment().format("dddd, MMMM Do of YYYY")
                        else if(lang === "ar") var date = moment().format("dddd, MMMM Do من YYYY")
                        ...
                        for(let i = 0; i < enabled.length; i++){
                            ...
                            if(!response.includes(enabled[i])){
                                ...
                                //add image
                                if(mode[0].image.includes("https://")) ActivePlaylist.setImage(mode[0].image)
                                else ActivePlaylist.setImage("https://i.imgur.com/RBFGS9F.jpeg")
