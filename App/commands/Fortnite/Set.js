...
module.exports = {
    ...
    expectedArgsEN: 'To start searching, type the command then set name.',
    ...
    callback: async (FNBRMENA, message, args, text, Discord, client, admin, userData, alias, emojisObject) => {
        ...
        .then(async res => {
            ...
            if(res.data.items.length === 0){
                ...
                return message.reply({embeds: [noSetHasBeenFoundError], components: [], files: []})
                .catch(err => {
            ...
            try {
                ...
                for(let i = 0; i < res.data.items.length; i++){
                    ...
                    if(res.data.items[i].images.icon === null) var image = 'https://firebasestorage.googleapis.com/v0/b/fnbrmena-bot.appspot.com/o/code_images%2FHVH5sqV.png?alt=media&token=41c26ee2-c98e-492d-a84c-299a69ac6012'
