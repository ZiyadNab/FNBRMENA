                    ...
                    if(lang === 'en'){
                        ...
                        message.channel.send(generating)
                            .then( async msg => {
                                ...
                                ctx.drawImage(border, 50, 1850, 550, 150);
                                const att = new Discord.MessageAttachment(canvas.toBuffer('image/jpeg', {quality: 0.5}))
                                imagePOI.setFooter('Generated By FNBR_MENA Bot')
                                imagePOI.setAuthor('FNBR_MENA Bot', 'https://i.imgur.com/LfotEkZ.jpg', 'https://twitter.com/FNBR_MENA')
                                await message.channel.send(att)
                                msg.delete({timeout: 500})
