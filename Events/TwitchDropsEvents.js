                                ...
                                if(owners.includes(res.data.data.currentUser.dropCampaigns[i].owner.id) || !ownering){
                                    ...
                                    .then(async detailed => {
                                        ...
                                        twitchDropsEmbed.addFields(
                                            ...
                                            {name: "Starts At", value: `\`${moment(detailed.data.data.user.dropCampaign.startAt).tz('America/Los_Angeles').format("dddd, MMMM Do of YYYY [at] h:mm A z")}\``},
                                            {name: "Ends At", value: `\`${moment(detailed.data.data.user.dropCampaign.endAt).tz('America/Los_Angeles').format("dddd, MMMM Do of YYYY [at] h:mm A z")}\``},
                                        )
