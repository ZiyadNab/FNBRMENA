                            ...
                            .then( async collected => {
                                ...
                                if(reaction.emoji.name === '🇸🇦'){
                                    ...
                                    if (res.data.verified === false){
                                        ...
                                        .setColor('#BB00EE')
                                        .setTitle('SAC Information')
                                        .setDescription('جميع المعلومات الخاصة بكود ' + arguments)
                                        .addFields(
                                            {name: 'الكود:', value: res.data.code},
                                            {name: 'الاسم:', value: res.data.account.name},
                                            {name: 'حالة الكود:', value: res.data.status},
                                            {name: 'توثيق الكود:', value: f}
                                        )
                                        .setFooter('Generated By FNBR_MENA Bot')
                                        .setAuthor('FNBR_MENA Bot', 'https://i.imgur.com/LfotEkZ.jpg', 'https://twitter.com/FNBR_MENA')
                                        await message.reply(sac);
