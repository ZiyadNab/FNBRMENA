    ...
    callback: async (FNBRMENA, message, args, text, Discord, client, admin, userData, alias, emojisObject) => {
        ...
        .then(async res => {
            ...
            if(res.data.items.length > 1){
                ...
                await message.reply({content: reply, embeds: [listOfCosmeticts], components: [], files: []})
                .then(async notify => {
            ...
            if(errorHandleing === 0){
                ...
                if(res.data.items.length !== 0){
                    ...
                    if(res.data.items[num].gameplayTags.includes("Cosmetics.Source.ItemShop")){
                        ...
                        if(!access.exists){
                            ...
                            if(snapshot.size + 1 <= 20){
                                ...
                                message.reply({embeds: [remindersHasPassedTheLimitError], components: [], files: []})
                            }
                        }else{
                            ...
                            message.reply({embeds: [itemIsAlreadyAddedError], components: [], files: []})
                        ...
                        message.reply({embeds: [itemSourceIsNotAnItemshopError], components: [], files: []})
                    }
                }else{
                    ...
                    message.reply({embeds: [noCosmeticsHasBeenFoundError], components: [], files: []})
