...
module.exports = {
    ...
    callback: async (message, args, text, Discord, client, admin, alias, errorEmoji, checkEmoji) => {
        ...
        admin.database().ref("ERA's").child("Users").child(message.author.id).once('value', async function (data) {
            ...
            ctx.fillText("FNBRMENA", (ctx.font.substring(0,ctx.font.indexOf("p")) - (4 * length)), (ctx.font.substring(0,ctx.font.indexOf("p"))))
            ctx.textAlign='right';
            ctx.fillText("AntMan V2", (canvas.width - (ctx.font.substring(0,ctx.font.indexOf("p")) - (4 * length))), (ctx.font.substring(0,ctx.font.indexOf("p"))))
